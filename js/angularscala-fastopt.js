...
ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V = (function($$this) {
  ScalaJS.i.Lcom_greencatsoft_angularjs_core_ScopeAware$class__initialize__Lcom_greencatsoft_angularjs_core_ScopeAware__V($$this);
  var scope = $$this.scope__Lcom_greencatsoft_angularjs_core_Scope();
  new ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope().init___Lcom_greencatsoft_angularjs_core_Scoped__Lcom_greencatsoft_angularjs_core_Scope($$this, scope).scope$1["controller"] = $$this
});
ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__buildConfig__Lcom_greencatsoft_angularjs_Directive__sjs_js_Dictionary__sjs_js_Dictionary = (function($$this, config) {
  config["link"] = (function(f) {
    return (function(arg1, arg2, arg3, arg4) {
      var scope = arg1;
      var elems = arg2;
      var controllers = arg4;
      var rc6 = false;
      var x2 = null;
      var x1 = ((controllers === (void 0)) ? ScalaJS.m.s_None() : new ScalaJS.c.s_Some().init___O(controllers));
      matchEnd7: {
        if (ScalaJS.is.s_Some(x1)) {
          rc6 = true;
          x2 = ScalaJS.as.s_Some(x1);
          var arr = x2.x$2;
          if (ScalaJS.uZ(ScalaJS.g["Array"]["isArray"](arr))) {
            var this$4 = new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(arr);
            var this$6 = ScalaJS.i.scm_IndexedSeqLike$class__thisCollection__scm_IndexedSeqLike__scm_IndexedSeq(this$4);
            var f$1 = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(x$1$2) {
              var x$1 = x$1$2;
              return ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().unbind__sjs_js_Any__s_Option(x$1)
            }));
            var this$5 = ScalaJS.m.sc_Seq();
            var bf = this$5.ReusableCBFInstance$2;
            ScalaJS.as.sc_Seq(ScalaJS.as.scg_GenericTraversableTemplate(ScalaJS.i.sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this$6, f$1, bf)).flatten__F1__sc_GenTraversable(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(xo$2) {
              var xo = ScalaJS.as.s_Option(xo$2);
              return xo.toList__sci_List()
            }))));
            f.$$outer$2;
            ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__bind$1__Lcom_greencatsoft_angularjs_Directive__Lcom_greencatsoft_angularjs_core_Scope__Lcom_greencatsoft_angularjs_core_Scope(f.$$outer$2, scope);
            new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(elems);
            break matchEnd7
          }
        };
        if (rc6) {
          var c = x2.x$2;
          var x1$2 = ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().unbind__sjs_js_Any__s_Option(c);
          if (ScalaJS.is.s_Some(x1$2)) {
            var x2$2 = ScalaJS.as.s_Some(x1$2);
            var arg = ScalaJS.as.Lcom_greencatsoft_angularjs_Controller(x2$2.x$2);
            f.$$outer$2;
            ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__bind$1__Lcom_greencatsoft_angularjs_Directive__Lcom_greencatsoft_angularjs_core_Scope__Lcom_greencatsoft_angularjs_core_Scope(f.$$outer$2, scope);
            new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(elems);
            ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_greencatsoft_angularjs_Controller.getArrayOf(), [arg]), 1));
            break matchEnd7
          } else {
            f.$$outer$2;
            ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__bind$1__Lcom_greencatsoft_angularjs_Directive__Lcom_greencatsoft_angularjs_core_Scope__Lcom_greencatsoft_angularjs_core_Scope(f.$$outer$2, scope);
            new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(elems);
            ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_greencatsoft_angularjs_Controller.getArrayOf(), []), 1));
            (void 0);
            break matchEnd7
          }
        };
  ...
  })(new ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1().init___Lcom_greencatsoft_angularjs_Directive($$this));
  return config
});
ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__bind$1__Lcom_greencatsoft_angularjs_Directive__Lcom_greencatsoft_angularjs_core_Scope__Lcom_greencatsoft_angularjs_core_Scope = (function($$this, scope) {
  new ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope().init___Lcom_greencatsoft_angularjs_core_Scoped__Lcom_greencatsoft_angularjs_core_Scope($$this, scope).scope$1["directive"] = $$this;
  return scope
});
ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__buildConfig__Lcom_greencatsoft_angularjs_ElementDirective__sjs_js_Dictionary__sjs_js_Dictionary = (function($$this, config) {
  config["transclude"] = $$this.transclude$1;
  config["replace"] = $$this.replace$1;
  return ScalaJS.i.Lcom_greencatsoft_angularjs_RestrictedDirective$class__buildConfig__Lcom_greencatsoft_angularjs_RestrictedDirective__sjs_js_Dictionary__sjs_js_Dictionary($$this, config)
});
ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__restrict__Lcom_greencatsoft_angularjs_ElementDirective__sci_Set = (function($$this) {
  return (ScalaJS.m.s_Predef().Set$2, new ScalaJS.c.sci_Set$Set1().init___O("E"))
});
ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__$init$__Lcom_greencatsoft_angularjs_ElementDirective__V = (function($$this) {
  $$this.transclude$1 = false;
  $$this.replace$1 = false
});
ScalaJS.i.Lcom_greencatsoft_angularjs_IsolatedScope$class__$init$__Lcom_greencatsoft_angularjs_IsolatedScope__V = (function($$this) {
  $$this.bindings$1 = ScalaJS.as.sc_Seq(ScalaJS.m.sc_Seq().empty__sc_GenTraversable())
});
ScalaJS.i.Lcom_greencatsoft_angularjs_IsolatedScope$class__buildConfig__Lcom_greencatsoft_angularjs_IsolatedScope__sjs_js_Dictionary__sjs_js_Dictionary = (function($$this, config) {
  var dict = ScalaJS.m.sjs_js_Dictionary().empty__sjs_js_Dictionary();
  $$this.bindings$1.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(dict$1) {
    return (function(b$2) {
      var b = ScalaJS.as.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding(b$2);
      dict$1[b.name__T()] = new ScalaJS.c.s_StringContext().init___sc_Seq(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["", "", ""]), 1))).s__sc_Seq__T(ScalaJS.m.s_Predef().genericWrapArray__O__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.O.getArrayOf(), [b.prefix__T(), b.attribute__T()])))
    })
  })(dict)));
  config["scope"] = dict;
  return ScalaJS.i.Lcom_greencatsoft_angularjs_TemplatedDirective$class__buildConfig__Lcom_greencatsoft_angularjs_TemplatedDirective__sjs_js_Dictionary__sjs_js_Dictionary($$this, config)
});
ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V = (function($$this) {
  $$this.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V(ScalaJS.objectGetClass($$this).getSimpleName__T())
});
ScalaJS.i.Lcom_greencatsoft_angularjs_RestrictedDirective$class__buildConfig__Lcom_greencatsoft_angularjs_RestrictedDirective__sjs_js_Dictionary__sjs_js_Dictionary = (function($$this, config) {
  var this$1 = ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__restrict__Lcom_greencatsoft_angularjs_ElementDirective__sci_Set($$this);
  config["restrict"] = ScalaJS.i.sc_TraversableOnce$class__mkString__sc_TraversableOnce__T__T__T__T(this$1, "", "", "");
  return ScalaJS.i.Lcom_greencatsoft_angularjs_Directive$class__buildConfig__Lcom_greencatsoft_angularjs_Directive__sjs_js_Dictionary__sjs_js_Dictionary($$this, config)
});
ScalaJS.i.Lcom_greencatsoft_angularjs_TemplatedDirective$class__buildConfig__Lcom_greencatsoft_angularjs_TemplatedDirective__sjs_js_Dictionary__sjs_js_Dictionary = (function($$this, config) {
  config["templateUrl"] = (function(arg$outer) {
    return (function(elems$2, attrs$2) {
      var elems = elems$2;
      new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(elems);
      return arg$outer.templateUrl$1
    })
  })($$this);
  return ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__buildConfig__Lcom_greencatsoft_angularjs_ElementDirective__sjs_js_Dictionary__sjs_js_Dictionary($$this, config)
});
ScalaJS.i.Lcom_greencatsoft_angularjs_core_ScopeAware$class__initialize__Lcom_greencatsoft_angularjs_core_ScopeAware__V = (function($$this) {
  $$this.scope$und$eq__Lcom_greencatsoft_angularjs_core_Scope__V($$this.rawScope__Lcom_greencatsoft_angularjs_core_Scope());
  $$this.initialize__Lcom_greencatsoft_angularjs_core_Scope__V($$this.scope__Lcom_greencatsoft_angularjs_core_Scope())
});
/** @constructor */
...
ScalaJS.i.scg_GenericTraversableTemplate$class__flatten__scg_GenericTraversableTemplate__F1__sc_GenTraversable = (function($$this, asTraversable) {
  var b = $$this.companion__scg_GenericCompanion().newBuilder__scm_Builder();
  ScalaJS.i.scg_GenericTraversableTemplate$class__sequential__scg_GenericTraversableTemplate__sc_TraversableOnce($$this).foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function($$this$1, b$1, asTraversable$1) {
    return (function(xs$2) {
      return ScalaJS.as.scm_Builder(b$1.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(ScalaJS.as.sc_GenTraversableOnce(asTraversable$1.apply__O__O(xs$2)).seq__sc_TraversableOnce()))
    })
  })($$this, b, asTraversable)));
  return ScalaJS.as.sc_GenTraversable(b.result__O())
});
ScalaJS.i.scg_GenericTraversableTemplate$class__sequential__scg_GenericTraversableTemplate__sc_TraversableOnce = (function($$this) {
  return ScalaJS.as.sc_GenTraversableOnce($$this).seq__sc_TraversableOnce()
});
...
ScalaJS.i.scm_ArrayOps$class__$colon$plus__scm_ArrayOps__O__s_reflect_ClassTag__O = (function($$this, elem, evidence$2) {
  ScalaJS.m.s_Array();
  var n1 = ((ScalaJS.m.sr_ScalaRunTime().array$undlength__O__I($$this.repr$1) + 1) | 0);
  var result = evidence$2.newArray__I__O(n1);
  ScalaJS.m.s_Array().copy__O__I__O__I__I__V($$this.repr$1, 0, result, 0, ScalaJS.m.sr_ScalaRunTime().array$undlength__O__I($$this.repr$1));
  ScalaJS.m.sr_ScalaRunTime().array$undupdate__O__I__O__V(result, ScalaJS.m.sr_ScalaRunTime().array$undlength__O__I($$this.repr$1), elem);
  return result
});
...
ScalaJS.c.LApp$.prototype.main__V = (function() {
  var module = ScalaJS.m.Lcom_greencatsoft_angularjs_Angular().module__T__sc_Seq__Lcom_greencatsoft_angularjs_Module("store", ScalaJS.m.sci_Nil());
  var jsx$1 = ScalaJS.m.Lcom_chandu0101_directives_ProductTitleDirective().name$1;
  var target = ScalaJS.m.Lcom_chandu0101_directives_ProductTitleDirective();
  var handler = (function(f) {
    return (function(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
      return f.apply__O__O__O__O__O__O__O__O__O__O__O__O(this, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10)
    })
  })(new ScalaJS.c.LApp$$anonfun$1().init___Lcom_greencatsoft_angularjs_Service(target));
  var proxy = [];
  ScalaJS.uI(proxy["push"](handler));
  module.module$1["directive"](jsx$1, proxy);
  var jsx$2 = ScalaJS.m.Lcom_chandu0101_controllers_StoreController().name$1;
  var target$2 = ScalaJS.m.Lcom_chandu0101_controllers_StoreController();
  var handler$2 = (function(f$1) {
    return (function(arg1$1, arg2$1, arg3$1, arg4$1, arg5$1, arg6$1, arg7$1, arg8$1, arg9$1, arg10$1) {
      return f$1.apply__O__O__O__O__O__O__O__O__O__O__O__O(this, arg1$1, arg2$1, arg3$1, arg4$1, arg5$1, arg6$1, arg7$1, arg8$1, arg9$1, arg10$1)
    })
  })(new ScalaJS.c.LApp$$anonfun$2().init___Lcom_greencatsoft_angularjs_Service(target$2));
  var proxy$2 = ["$storeService", "$scope"];
  ScalaJS.uI(proxy$2["push"](handler$2));
  module.module$1["controller"](jsx$2, proxy$2);
  var jsx$3 = ScalaJS.m.Lcom_chandu0101_controllers_PanelController().name$1;
  var target$3 = ScalaJS.m.Lcom_chandu0101_controllers_PanelController();
  var handler$3 = (function(f$2) {
    return (function(arg1$2, arg2$2, arg3$2, arg4$2, arg5$2, arg6$2, arg7$2, arg8$2, arg9$2, arg10$2) {
      return f$2.apply__O__O__O__O__O__O__O__O__O__O__O__O(this, arg1$2, arg2$2, arg3$2, arg4$2, arg5$2, arg6$2, arg7$2, arg8$2, arg9$2, arg10$2)
    })
  })(new ScalaJS.c.LApp$$anonfun$3().init___Lcom_greencatsoft_angularjs_Service(target$3));
  var proxy$3 = ["$scope"];
  ScalaJS.uI(proxy$3["push"](handler$3));
  module.module$1["controller"](jsx$3, proxy$3);
  var jsx$4 = ScalaJS.m.Lcom_chandu0101_controllers_ReviewController().name$1;
  var target$4 = ScalaJS.m.Lcom_chandu0101_controllers_ReviewController();
  var handler$4 = (function(f$3) {
    return (function(arg1$3, arg2$3, arg3$3, arg4$3, arg5$3, arg6$3, arg7$3, arg8$3, arg9$3, arg10$3) {
      return f$3.apply__O__O__O__O__O__O__O__O__O__O__O__O(this, arg1$3, arg2$3, arg3$3, arg4$3, arg5$3, arg6$3, arg7$3, arg8$3, arg9$3, arg10$3)
    })
  })(new ScalaJS.c.LApp$$anonfun$4().init___Lcom_greencatsoft_angularjs_Service(target$4));
  var proxy$4 = ["$scope"];
  ScalaJS.uI(proxy$4["push"](handler$4));
  module.module$1["controller"](jsx$4, proxy$4);
  var jsx$5 = ScalaJS.m.Lcom_chandu0101_services_StoreServiceFactory().name$1;
  var target$5 = ScalaJS.m.Lcom_chandu0101_services_StoreServiceFactory();
  var handler$5 = (function(f$4) {
    return (function(arg1$4, arg2$4, arg3$4, arg4$4, arg5$4, arg6$4, arg7$4, arg8$4, arg9$4, arg10$4) {
      return f$4.apply__O__O__O__O__O__O__O__O__O__O__O__O(this, arg1$4, arg2$4, arg3$4, arg4$4, arg5$4, arg6$4, arg7$4, arg8$4, arg9$4, arg10$4)
    })
  })(new ScalaJS.c.LApp$$anonfun$5().init___Lcom_greencatsoft_angularjs_Service(target$5));
  var proxy$5 = ["$http"];
  ScalaJS.uI(proxy$5["push"](handler$5));
  module.module$1["factory"](jsx$5, proxy$5)
});
...
/** @constructor */
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$ = (function() {
  ScalaJS.c.O.call(this);
  this.name$1 = null;
  this.rawScope$1 = null;
  this.scope$1 = null
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.constructor = ScalaJS.c.Lcom_chandu0101_controllers_PanelController$;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_controllers_PanelController$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_controllers_PanelController$.prototype = ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype;
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_chandu0101_controllers_PanelController = this;
  ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V(this);
  this.name$1 = "panelCtrl";
  return this
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.$$js$exported$meth$selectTab__I__O = (function(num) {
  return (this.selectTab__I__V(num), (void 0))
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.rawScope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.rawScope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.selectTab__I__V = (function(num) {
  this.scope$1["tab"] = num
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.isSelected__I__Z = (function(num) {
  return (num === ScalaJS.uI(this.scope$1["tab"]))
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.scope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.scope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.scope$und$eq__Lcom_greencatsoft_angularjs_core_Scope__V = (function(x$1) {
  this.scope$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V = (function(x$1) {
  /*<skip>*/
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.$$js$exported$meth$isSelected__I__O = (function(num) {
  return this.isSelected__I__Z(num)
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.initialize__Lcom_greencatsoft_angularjs_core_Scope__V = (function(scope) {
  this.initialize__Lcom_chandu0101_controllers_PanelController$ScopeType__V(scope)
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.initialize__Lcom_chandu0101_controllers_PanelController$ScopeType__V = (function(scope) {
  scope["tab"] = 1
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype["selectTab"] = (function(arg$1) {
  if ((arg$1 === null)) {
    throw "Found null, expected Int"
  } else {
    arg$1 = ScalaJS.uI(arg$1)
  };
  return this.$$js$exported$meth$selectTab__I__O(arg$1)
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype["isSelected"] = (function(arg$1) {
  if ((arg$1 === null)) {
    throw "Found null, expected Int"
  } else {
    arg$1 = ScalaJS.uI(arg$1)
  };
  return this.$$js$exported$meth$isSelected__I__O(arg$1)
});
ScalaJS.is.Lcom_chandu0101_controllers_PanelController$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_controllers_PanelController$)))
});
ScalaJS.as.Lcom_chandu0101_controllers_PanelController$ = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_controllers_PanelController$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.controllers.PanelController$"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_controllers_PanelController$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_controllers_PanelController$)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_controllers_PanelController$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_controllers_PanelController$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.controllers.PanelController$;", depth))
});
ScalaJS.d.Lcom_chandu0101_controllers_PanelController$ = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_controllers_PanelController$: 0
}, false, "com.chandu0101.controllers.PanelController$", ScalaJS.d.O, {
  Lcom_chandu0101_controllers_PanelController$: 1,
  Lcom_greencatsoft_angularjs_Controller: 1,
  Lcom_greencatsoft_angularjs_core_ScopeAware: 1,
  Lcom_greencatsoft_angularjs_core_Scoped: 1,
  Lcom_greencatsoft_angularjs_Initializable: 1,
  Lcom_greencatsoft_angularjs_NamedService: 1,
  Lcom_greencatsoft_angularjs_Named: 1,
  Lcom_greencatsoft_angularjs_Service: 1,
  O: 1
});
ScalaJS.c.Lcom_chandu0101_controllers_PanelController$.prototype.$classData = ScalaJS.d.Lcom_chandu0101_controllers_PanelController$;
ScalaJS.n.Lcom_chandu0101_controllers_PanelController = (void 0);
ScalaJS.m.Lcom_chandu0101_controllers_PanelController = (function() {
  if ((!ScalaJS.n.Lcom_chandu0101_controllers_PanelController)) {
    ScalaJS.n.Lcom_chandu0101_controllers_PanelController = new ScalaJS.c.Lcom_chandu0101_controllers_PanelController$().init___()
  };
  return ScalaJS.n.Lcom_chandu0101_controllers_PanelController
});
ScalaJS.e["PanelController"] = ScalaJS.m.Lcom_chandu0101_controllers_PanelController;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$ = (function() {
  ScalaJS.c.O.call(this);
  this.name$1 = null;
  this.rawScope$1 = null;
  this.scope$1 = null
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.constructor = ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_controllers_ReviewController$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_controllers_ReviewController$.prototype = ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype;
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.initialize__Lcom_chandu0101_controllers_ReviewController$ScopeType__V = (function(scope) {
  scope["review"] = null
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_chandu0101_controllers_ReviewController = this;
  ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V(this);
  this.name$1 = "reviewCtrl";
  return this
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.rawScope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.rawScope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.scope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.scope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.scope$und$eq__Lcom_greencatsoft_angularjs_core_Scope__V = (function(x$1) {
  this.scope$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V = (function(x$1) {
  /*<skip>*/
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.addReview__Lcom_chandu0101_model_Product__V = (function(product) {
  var x = ("got product : " + product);
  var this$2 = ScalaJS.m.s_Console();
  this$2.out__Ljava_io_PrintStream().println__O__V(x);
  var x$1 = ("current review : " + ScalaJS.as.Lcom_chandu0101_model_Review(this.scope$1["review"]));
  var this$4 = ScalaJS.m.s_Console();
  this$4.out__Ljava_io_PrintStream().println__O__V(x$1);
  var xs = product.reviews$1;
  var this$6 = new ScalaJS.c.scm_ArrayOps$ofRef().init___AO(xs);
  var elem = ScalaJS.as.Lcom_chandu0101_model_Review(this.scope$1["review"]);
  var evidence$2 = ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.Lcom_chandu0101_model_Review.getClassOf());
  product.reviews$1 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(ScalaJS.i.scm_ArrayOps$class__$colon$plus__scm_ArrayOps__O__s_reflect_ClassTag__O(this$6, elem, evidence$2), 1);
  this.scope$1["review"] = null
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.$$js$exported$meth$addReview__Lcom_chandu0101_model_Product__O = (function(product) {
  return (this.addReview__Lcom_chandu0101_model_Product__V(product), (void 0))
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.initialize__Lcom_greencatsoft_angularjs_core_Scope__V = (function(scope) {
  this.initialize__Lcom_chandu0101_controllers_ReviewController$ScopeType__V(scope)
});
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype["addReview"] = (function(arg$1) {
  arg$1 = ScalaJS.as.Lcom_chandu0101_model_Product(arg$1);
  return this.$$js$exported$meth$addReview__Lcom_chandu0101_model_Product__O(arg$1)
});
ScalaJS.is.Lcom_chandu0101_controllers_ReviewController$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_controllers_ReviewController$)))
});
ScalaJS.as.Lcom_chandu0101_controllers_ReviewController$ = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_controllers_ReviewController$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.controllers.ReviewController$"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_controllers_ReviewController$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_controllers_ReviewController$)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_controllers_ReviewController$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_controllers_ReviewController$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.controllers.ReviewController$;", depth))
});
ScalaJS.d.Lcom_chandu0101_controllers_ReviewController$ = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_controllers_ReviewController$: 0
}, false, "com.chandu0101.controllers.ReviewController$", ScalaJS.d.O, {
  Lcom_chandu0101_controllers_ReviewController$: 1,
  Lcom_greencatsoft_angularjs_Controller: 1,
  Lcom_greencatsoft_angularjs_core_ScopeAware: 1,
  Lcom_greencatsoft_angularjs_core_Scoped: 1,
  Lcom_greencatsoft_angularjs_Initializable: 1,
...
ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$.prototype.$classData = ScalaJS.d.Lcom_chandu0101_controllers_ReviewController$;
ScalaJS.n.Lcom_chandu0101_controllers_ReviewController = (void 0);
ScalaJS.m.Lcom_chandu0101_controllers_ReviewController = (function() {
  if ((!ScalaJS.n.Lcom_chandu0101_controllers_ReviewController)) {
    ScalaJS.n.Lcom_chandu0101_controllers_ReviewController = new ScalaJS.c.Lcom_chandu0101_controllers_ReviewController$().init___()
  };
  return ScalaJS.n.Lcom_chandu0101_controllers_ReviewController
});
ScalaJS.e["ReviewController"] = ScalaJS.m.Lcom_chandu0101_controllers_ReviewController;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$ = (function() {
  ScalaJS.c.O.call(this);
  this.name$1 = null;
  this.service$1 = null;
  this.rawScope$1 = null;
...
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.constructor = ScalaJS.c.Lcom_chandu0101_controllers_StoreController$;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_controllers_StoreController$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_controllers_StoreController$.prototype = ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype;
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_chandu0101_controllers_StoreController = this;
  ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V(this);
  this.name$1 = "storeCtrl";
  return this
});
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.rawScope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.rawScope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.scope__Lcom_greencatsoft_angularjs_core_Scope = (function() {
  return this.scope$1
});
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.scope$und$eq__Lcom_greencatsoft_angularjs_core_Scope__V = (function(x$1) {
  this.scope$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V = (function(x$1) {
  /*<skip>*/
});
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.initialize__Lcom_chandu0101_controllers_StoreController$StoreForm__V = (function(scope) {
  var $$this = this.service$1.findAll__sc_Seq();
...
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.initialize__Lcom_greencatsoft_angularjs_core_Scope__V = (function(scope) {
  this.initialize__Lcom_chandu0101_controllers_StoreController$StoreForm__V(scope)
});
ScalaJS.is.Lcom_chandu0101_controllers_StoreController$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_controllers_StoreController$)))
});
ScalaJS.as.Lcom_chandu0101_controllers_StoreController$ = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_controllers_StoreController$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.controllers.StoreController$"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_controllers_StoreController$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_controllers_StoreController$)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_controllers_StoreController$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_controllers_StoreController$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.controllers.StoreController$;", depth))
});
ScalaJS.d.Lcom_chandu0101_controllers_StoreController$ = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_controllers_StoreController$: 0
}, false, "com.chandu0101.controllers.StoreController$", ScalaJS.d.O, {
  Lcom_chandu0101_controllers_StoreController$: 1,
  Lcom_greencatsoft_angularjs_Controller: 1,
  Lcom_greencatsoft_angularjs_core_ScopeAware: 1,
  Lcom_greencatsoft_angularjs_core_Scoped: 1,
  Lcom_greencatsoft_angularjs_Initializable: 1,
...
ScalaJS.c.Lcom_chandu0101_controllers_StoreController$.prototype.$classData = ScalaJS.d.Lcom_chandu0101_controllers_StoreController$;
ScalaJS.n.Lcom_chandu0101_controllers_StoreController = (void 0);
ScalaJS.m.Lcom_chandu0101_controllers_StoreController = (function() {
  if ((!ScalaJS.n.Lcom_chandu0101_controllers_StoreController)) {
    ScalaJS.n.Lcom_chandu0101_controllers_StoreController = new ScalaJS.c.Lcom_chandu0101_controllers_StoreController$().init___()
  };
  return ScalaJS.n.Lcom_chandu0101_controllers_StoreController
});
ScalaJS.e["StoreController"] = ScalaJS.m.Lcom_chandu0101_controllers_StoreController;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$ = (function() {
  ScalaJS.c.O.call(this);
  this.templateUrl$1 = null;
  this.name$1 = null;
  this.bindings$1 = null;
  this.transclude$1 = false;
  this.replace$1 = false;
  this.UnidirectionalBinding$module$1 = null;
  this.BidirectionalBinding$module$1 = null;
  this.BehavioralBinding$module$1 = null
});
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.constructor = ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_directives_ProductTitleDirective$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_directives_ProductTitleDirective$.prototype = ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype;
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_chandu0101_directives_ProductTitleDirective = this;
  ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V(this);
  ScalaJS.i.Lcom_greencatsoft_angularjs_ElementDirective$class__$init$__Lcom_greencatsoft_angularjs_ElementDirective__V(this);
  ScalaJS.i.Lcom_greencatsoft_angularjs_IsolatedScope$class__$init$__Lcom_greencatsoft_angularjs_IsolatedScope__V(this);
  this.templateUrl$1 = "product-title.html";
  this.name$1 = "productTitle";
  return this
});
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.toString__T = (function() {
  return "<function0>"
});
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V = (function(x$1) {
  /*<skip>*/
});
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.apply__O = (function() {
  var config = ScalaJS.m.sjs_js_Dictionary().empty__sjs_js_Dictionary();
  return ScalaJS.i.Lcom_greencatsoft_angularjs_IsolatedScope$class__buildConfig__Lcom_greencatsoft_angularjs_IsolatedScope__sjs_js_Dictionary__sjs_js_Dictionary(this, config)
});
ScalaJS.is.Lcom_chandu0101_directives_ProductTitleDirective$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_directives_ProductTitleDirective$)))
});
ScalaJS.as.Lcom_chandu0101_directives_ProductTitleDirective$ = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_directives_ProductTitleDirective$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.directives.ProductTitleDirective$"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_directives_ProductTitleDirective$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_directives_ProductTitleDirective$)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_directives_ProductTitleDirective$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_directives_ProductTitleDirective$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.directives.ProductTitleDirective$;", depth))
});
ScalaJS.d.Lcom_chandu0101_directives_ProductTitleDirective$ = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_directives_ProductTitleDirective$: 0
}, false, "com.chandu0101.directives.ProductTitleDirective$", ScalaJS.d.O, {
  Lcom_chandu0101_directives_ProductTitleDirective$: 1,
  Lcom_greencatsoft_angularjs_IsolatedScope: 1,
  Lcom_greencatsoft_angularjs_ScopeStrategy: 1,
  Lcom_greencatsoft_angularjs_TemplatedDirective: 1,
  Lcom_greencatsoft_angularjs_Templated: 1,
  Lcom_greencatsoft_angularjs_ElementDirective: 1,
  Lcom_greencatsoft_angularjs_RestrictedDirective: 1,
  Lcom_greencatsoft_angularjs_Directive: 1,
  Lcom_greencatsoft_angularjs_internal_ConfigBuilder: 1,
  Lcom_greencatsoft_angularjs_core_Scoped: 1,
  F0: 1,
  Lcom_greencatsoft_angularjs_NamedService: 1,
  Lcom_greencatsoft_angularjs_Named: 1,
...
ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$.prototype.$classData = ScalaJS.d.Lcom_chandu0101_directives_ProductTitleDirective$;
ScalaJS.n.Lcom_chandu0101_directives_ProductTitleDirective = (void 0);
ScalaJS.m.Lcom_chandu0101_directives_ProductTitleDirective = (function() {
  if ((!ScalaJS.n.Lcom_chandu0101_directives_ProductTitleDirective)) {
    ScalaJS.n.Lcom_chandu0101_directives_ProductTitleDirective = new ScalaJS.c.Lcom_chandu0101_directives_ProductTitleDirective$().init___()
  };
  return ScalaJS.n.Lcom_chandu0101_directives_ProductTitleDirective
});
ScalaJS.e["ProductTitleDirective"] = ScalaJS.m.Lcom_chandu0101_directives_ProductTitleDirective;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_model_Product = (function() {
  ScalaJS.c.O.call(this);
  this.name$1 = null;
  this.price$1 = 0.0;
  this.description$1 = null;
  this.canPurchase$1 = false;
  this.images$1 = null;
  this.reviews$1 = null
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.constructor = ScalaJS.c.Lcom_chandu0101_model_Product;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_model_Product = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_model_Product.prototype = ScalaJS.c.Lcom_chandu0101_model_Product.prototype;
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.productPrefix__T = (function() {
  return "Product"
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.productArity__I = (function() {
  return 6
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$1__T = (function() {
  return this.name$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$name__O = (function() {
  return this.name$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$canPurchase__O = (function() {
  return this.canPurchase$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lcom_chandu0101_model_Product(x$1)) {
    var Product$1 = ScalaJS.as.Lcom_chandu0101_model_Product(x$1);
    return ((((((ScalaJS.anyRefEqEq(this.name$1, Product$1.name$1) && (this.price$1 === Product$1.price$1)) && ScalaJS.anyRefEqEq(this.description$1, Product$1.description$1)) && (this.canPurchase$1 === Product$1.canPurchase$1)) && (this.images$1 === Product$1.images$1)) && (this.reviews$1 === Product$1.reviews$1)) && Product$1.canEqual__O__Z(this))
  } else {
    return false
  }
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$6__ALcom_chandu0101_model_Review = (function() {
  return this.reviews$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$toString__O = (function() {
  return ScalaJS.m.sr_ScalaRunTime().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.name$1;
...
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy__T__D__T__Z__AT__ALcom_chandu0101_model_Review__O = (function(name, price, description, canPurchase, images, reviews) {
  return new ScalaJS.c.Lcom_chandu0101_model_Product().init___T__D__T__Z__AT__ALcom_chandu0101_model_Review(name, price, description, canPurchase, images, reviews)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$reviews__ALcom_chandu0101_model_Review__O = (function(x$1) {
  this.reviews$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$productIterator__O = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$productArity__O = (function() {
  return 6
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Lcom_chandu0101_model_Product(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.init___T__D__T__Z__AT__ALcom_chandu0101_model_Review = (function(name, price, description, canPurchase, images, reviews) {
  this.name$1 = name;
  this.price$1 = price;
  this.description$1 = description;
  this.canPurchase$1 = canPurchase;
  this.images$1 = images;
  this.reviews$1 = reviews;
  return this
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$4__Z = (function() {
  return this.canPurchase$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$productPrefix__O = (function() {
  return "Product"
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$canEqual__O__O = (function(x$1) {
  return this.canEqual__O__Z(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.hashCode__I = (function() {
  var acc = -889275714;
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.name$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().doubleHash__D__I(this.price$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.description$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, (this.canPurchase$1 ? 1231 : 1237));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.images$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.reviews$1));
  return ScalaJS.m.sr_Statics().finalizeHash__I__I__I(acc, 6)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$description__O = (function() {
  return this.description$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$productElement__I__O = (function(x$1) {
  return this.productElement__I__O(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$5__AT = (function() {
  return this.images$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$images__O = (function() {
  return this.images$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$2__D = (function() {
  return this.price$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$reviews__O = (function() {
  return this.reviews$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$copy$default$3__T = (function() {
  return this.description$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$prop$price__O = (function() {
  return this.price$1
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$equals__O__O = (function(x$1) {
  return this.equals__O__Z(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$$js$exported$meth$hashCode__O = (function() {
  return this.hashCode__I()
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "name", {
  "get": (function() {
    return this.$$js$exported$prop$name__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "price", {
  "get": (function() {
    return this.$$js$exported$prop$price__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "description", {
  "get": (function() {
    return this.$$js$exported$prop$description__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "canPurchase", {
  "get": (function() {
    return this.$$js$exported$prop$canPurchase__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "images", {
  "get": (function() {
    return this.$$js$exported$prop$images__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "reviews", {
  "set": (function(arg$1) {
    arg$1 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(arg$1, 1);
    this.$$js$exported$prop$reviews__ALcom_chandu0101_model_Review__O(arg$1)
  }),
  "get": (function() {
    return this.$$js$exported$prop$reviews__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["copy"] = (function(arg$1, arg$2, arg$3, arg$4, arg$5, arg$6) {
  if ((arg$1 === (void 0))) {
    arg$1 = this.$$js$exported$meth$copy$default$1__T()
  } else {
  ...
  if ((arg$3 === (void 0))) {
    arg$3 = this.$$js$exported$meth$copy$default$3__T()
  } else {
    arg$3 = ScalaJS.as.T(arg$3)
  };
  if ((arg$4 === (void 0))) {
    arg$4 = this.$$js$exported$meth$copy$default$4__Z()
  } else if ((arg$4 === null)) {
    throw "Found null, expected Boolean"
  } else {
    arg$4 = ScalaJS.uZ(arg$4)
  };
  if ((arg$5 === (void 0))) {
    arg$5 = this.$$js$exported$meth$copy$default$5__AT()
  } else {
    arg$5 = ScalaJS.asArrayOf.T(arg$5, 1)
  };
  if ((arg$6 === (void 0))) {
    arg$6 = this.$$js$exported$meth$copy$default$6__ALcom_chandu0101_model_Review()
  } else {
    arg$6 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(arg$6, 1)
  };
  return this.$$js$exported$meth$copy__T__D__T__Z__AT__ALcom_chandu0101_model_Review__O(arg$1, arg$2, arg$3, arg$4, arg$5, arg$6)
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "productPrefix", {
  "get": (function() {
    return this.$$js$exported$prop$productPrefix__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "productArity", {
  "get": (function() {
    return this.$$js$exported$prop$productArity__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["productElement"] = (function(arg$1) {
  if ((arg$1 === null)) {
    throw "Found null, expected Int"
  } else {
    arg$1 = ScalaJS.uI(arg$1)
...
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Product.prototype, "productIterator", {
  "get": (function() {
    return this.$$js$exported$prop$productIterator__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["canEqual"] = (function(arg$1) {
  arg$1 = ScalaJS.as.O(arg$1);
  return this.$$js$exported$meth$canEqual__O__O(arg$1)
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["hashCode"] = (function() {
  return this.$$js$exported$meth$hashCode__O()
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["toString"] = (function() {
  return this.$$js$exported$meth$toString__O()
});
ScalaJS.c.Lcom_chandu0101_model_Product.prototype["equals"] = (function(arg$1) {
  arg$1 = ScalaJS.as.O(arg$1);
  return this.$$js$exported$meth$equals__O__O(arg$1)
});
ScalaJS.is.Lcom_chandu0101_model_Product = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_model_Product)))
});
ScalaJS.as.Lcom_chandu0101_model_Product = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_model_Product(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.model.Product"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_model_Product = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_model_Product)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_model_Product = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_model_Product(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.model.Product;", depth))
});
ScalaJS.d.Lcom_chandu0101_model_Product = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_model_Product: 0
}, false, "com.chandu0101.model.Product", ScalaJS.d.O, {
  Lcom_chandu0101_model_Product: 1,
  s_Serializable: 1,
...
ScalaJS.c.Lcom_chandu0101_model_Product.prototype.$classData = ScalaJS.d.Lcom_chandu0101_model_Product;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_model_Review = (function() {
  ScalaJS.c.O.call(this);
  this.stars$1 = 0;
  this.body$1 = null;
  this.author$1 = null
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.constructor = ScalaJS.c.Lcom_chandu0101_model_Review;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_model_Review = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_model_Review.prototype = ScalaJS.c.Lcom_chandu0101_model_Review.prototype;
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.productPrefix__T = (function() {
  return "Review"
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.productArity__I = (function() {
  return 3
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$copy__I__T__T__O = (function(stars, body, author) {
  return new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(stars, body, author)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Lcom_chandu0101_model_Review(x$1)) {
    var Review$1 = ScalaJS.as.Lcom_chandu0101_model_Review(x$1);
    return ((((this.stars$1 === Review$1.stars$1) && ScalaJS.anyRefEqEq(this.body$1, Review$1.body$1)) && ScalaJS.anyRefEqEq(this.author$1, Review$1.author$1)) && Review$1.canEqual__O__Z(this))
  } else {
    return false
  }
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$toString__O = (function() {
  return ScalaJS.m.sr_ScalaRunTime().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.stars$1;
...
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$author__T__O = (function(x$1) {
  this.author$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$productIterator__O = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$productArity__O = (function() {
  return 3
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$copy$default$2__T = (function() {
  return this.body$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$stars__I__O = (function(x$1) {
  this.stars$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Lcom_chandu0101_model_Review(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$body__T__O = (function(x$1) {
  this.body$1 = x$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$author__O = (function() {
  return this.author$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$productPrefix__O = (function() {
  return "Review"
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$copy$default$1__I = (function() {
  return this.stars$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$canEqual__O__O = (function(x$1) {
  return this.canEqual__O__Z(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.hashCode__I = (function() {
  var acc = -889275714;
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, this.stars$1);
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.body$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.author$1));
  return ScalaJS.m.sr_Statics().finalizeHash__I__I__I(acc, 3)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$productElement__I__O = (function(x$1) {
  return this.productElement__I__O(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$stars__O = (function() {
  return this.stars$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$prop$body__O = (function() {
  return this.body$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$copy$default$3__T = (function() {
  return this.author$1
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.init___I__T__T = (function(stars, body, author) {
  this.stars$1 = stars;
  this.body$1 = body;
  this.author$1 = author;
  return this
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$equals__O__O = (function(x$1) {
  return this.equals__O__Z(x$1)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$$js$exported$meth$hashCode__O = (function() {
  return this.hashCode__I()
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "stars", {
  "set": (function(arg$1) {
    if ((arg$1 === null)) {
      throw "Found null, expected Int"
    } else {
    ...
    this.$$js$exported$prop$stars__I__O(arg$1)
  }),
  "get": (function() {
    return this.$$js$exported$prop$stars__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "body", {
  "set": (function(arg$1) {
    arg$1 = ScalaJS.as.T(arg$1);
    this.$$js$exported$prop$body__T__O(arg$1)
  }),
  "get": (function() {
...
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "author", {
  "set": (function(arg$1) {
    arg$1 = ScalaJS.as.T(arg$1);
    this.$$js$exported$prop$author__T__O(arg$1)
  }),
  "get": (function() {
    return this.$$js$exported$prop$author__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["copy"] = (function(arg$1, arg$2, arg$3) {
  if ((arg$1 === (void 0))) {
    arg$1 = this.$$js$exported$meth$copy$default$1__I()
  } else if ((arg$1 === null)) {
    throw "Found null, expected Int"
  } else {
    arg$1 = ScalaJS.uI(arg$1)
  ...
  if ((arg$2 === (void 0))) {
    arg$2 = this.$$js$exported$meth$copy$default$2__T()
  } else {
  ...
  return this.$$js$exported$meth$copy__I__T__T__O(arg$1, arg$2, arg$3)
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "productPrefix", {
  "get": (function() {
    return this.$$js$exported$prop$productPrefix__O()
  }),
  "enumerable": true
});
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "productArity", {
  "get": (function() {
    return this.$$js$exported$prop$productArity__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["productElement"] = (function(arg$1) {
  if ((arg$1 === null)) {
    throw "Found null, expected Int"
  } else {
    arg$1 = ScalaJS.uI(arg$1)
...
Object["defineProperty"](ScalaJS.c.Lcom_chandu0101_model_Review.prototype, "productIterator", {
  "get": (function() {
    return this.$$js$exported$prop$productIterator__O()
  }),
  "enumerable": true
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["canEqual"] = (function(arg$1) {
  arg$1 = ScalaJS.as.O(arg$1);
  return this.$$js$exported$meth$canEqual__O__O(arg$1)
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["hashCode"] = (function() {
  return this.$$js$exported$meth$hashCode__O()
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["toString"] = (function() {
  return this.$$js$exported$meth$toString__O()
});
ScalaJS.c.Lcom_chandu0101_model_Review.prototype["equals"] = (function(arg$1) {
  arg$1 = ScalaJS.as.O(arg$1);
  return this.$$js$exported$meth$equals__O__O(arg$1)
});
ScalaJS.is.Lcom_chandu0101_model_Review = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_model_Review)))
});
ScalaJS.as.Lcom_chandu0101_model_Review = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_model_Review(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.model.Review"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_model_Review = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_model_Review)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_model_Review = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_model_Review(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.model.Review;", depth))
});
ScalaJS.d.Lcom_chandu0101_model_Review = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_model_Review: 0
}, false, "com.chandu0101.model.Review", ScalaJS.d.O, {
  Lcom_chandu0101_model_Review: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  s_Product: 1,
  s_Equals: 1,
...
ScalaJS.c.Lcom_chandu0101_model_Review.prototype.$classData = ScalaJS.d.Lcom_chandu0101_model_Review;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_services_StoreService = (function() {
  ScalaJS.c.O.call(this);
  this.http$1 = null
});
ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype.constructor = ScalaJS.c.Lcom_chandu0101_services_StoreService;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_services_StoreService = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_services_StoreService.prototype = ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype;
ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype.findAll__sc_Seq = (function() {
  var jsx$4 = ScalaJS.m.sc_Seq();
  var jsx$3 = ScalaJS.m.s_Predef();
  var x$4 = ScalaJS.asArrayOf.T(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["gem1-01.gif", "gem1-02.gif", "gem1-03.gif"]), 1)), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.T.getClassOf())), 1);
  var x$5 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_chandu0101_model_Review.getArrayOf(), [new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(3, "ok product", "name1@gmail.com"), new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(2, "bad product", "name2@gmail.com")])), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.Lcom_chandu0101_model_Review.getClassOf())), 1);
  var jsx$2 = new ScalaJS.c.Lcom_chandu0101_model_Product().init___T__D__T__Z__AT__ALcom_chandu0101_model_Review("Bloodstone", 100.0, "Excellent gem", true, x$4, x$5);
  var x$10 = ScalaJS.asArrayOf.T(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["gem2-01.gif", "gem2-02.gif", "gem2-03.gif"]), 1)), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.T.getClassOf())), 1);
  var x$11 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_chandu0101_model_Review.getArrayOf(), [new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(4, "ok product", "name1@gmail.com"), new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(5, "bad product", "name2@gmail.com")])), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.Lcom_chandu0101_model_Review.getClassOf())), 1);
  var jsx$1 = new ScalaJS.c.Lcom_chandu0101_model_Product().init___T__D__T__Z__AT__ALcom_chandu0101_model_Review("Zicrom", 1000.0, "Moderate gem", true, x$10, x$11);
  var x$16 = ScalaJS.asArrayOf.T(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["gem3-01.gif", "gem1-02.gif"]), 1)), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.T.getClassOf())), 1);
  var x$17 = ScalaJS.asArrayOf.Lcom_chandu0101_model_Review(ScalaJS.m.s_Array().apply__sc_Seq__s_reflect_ClassTag__O(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_chandu0101_model_Review.getArrayOf(), [new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(5, "ok product", "name1@gmail.com"), new ScalaJS.c.Lcom_chandu0101_model_Review().init___I__T__T(2, "bad product", "name2@gmail.com")])), ScalaJS.m.s_reflect_ClassTag().apply__jl_Class__s_reflect_ClassTag(ScalaJS.d.Lcom_chandu0101_model_Review.getClassOf())), 1);
  return ScalaJS.as.sc_Seq(jsx$4.apply__sc_Seq__sc_GenTraversable(jsx$3.wrapRefArray__AO__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.Lcom_chandu0101_model_Product.getArrayOf(), [jsx$2, jsx$1, new ScalaJS.c.Lcom_chandu0101_model_Product().init___T__D__T__Z__AT__ALcom_chandu0101_model_Review("Aricon", 502.0, "Moderate gem", true, x$16, x$17)]))))
});
ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype.init___Lcom_greencatsoft_angularjs_core_HttpService = (function(http) {
  this.http$1 = http;
  return this
});
ScalaJS.is.Lcom_chandu0101_services_StoreService = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_services_StoreService)))
});
ScalaJS.as.Lcom_chandu0101_services_StoreService = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_services_StoreService(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.services.StoreService"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_services_StoreService = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_services_StoreService)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_services_StoreService = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_services_StoreService(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.services.StoreService;", depth))
});
ScalaJS.d.Lcom_chandu0101_services_StoreService = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_services_StoreService: 0
}, false, "com.chandu0101.services.StoreService", ScalaJS.d.O, {
  Lcom_chandu0101_services_StoreService: 1,
  O: 1
});
ScalaJS.c.Lcom_chandu0101_services_StoreService.prototype.$classData = ScalaJS.d.Lcom_chandu0101_services_StoreService;
/** @constructor */
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$ = (function() {
  ScalaJS.c.O.call(this);
  this.name$1 = null;
  this.http$1 = null
});
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.constructor = ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$;
/** @constructor */
ScalaJS.h.Lcom_chandu0101_services_StoreServiceFactory$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_chandu0101_services_StoreServiceFactory$.prototype = ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype;
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.init___ = (function() {
  ScalaJS.n.Lcom_chandu0101_services_StoreServiceFactory = this;
  ScalaJS.i.Lcom_greencatsoft_angularjs_Named$class__$init$__Lcom_greencatsoft_angularjs_Named__V(this);
  this.name$1 = "$storeService";
  return this
});
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.toString__T = (function() {
  return "<function0>"
});
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.com$greencatsoft$angularjs$Named$$undsetter$und$name$und$eq__T__V = (function(x$1) {
  /*<skip>*/
});
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.apply__O = (function() {
  return new ScalaJS.c.Lcom_chandu0101_services_StoreService().init___Lcom_greencatsoft_angularjs_core_HttpService(this.http$1)
});
ScalaJS.is.Lcom_chandu0101_services_StoreServiceFactory$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_chandu0101_services_StoreServiceFactory$)))
});
ScalaJS.as.Lcom_chandu0101_services_StoreServiceFactory$ = (function(obj) {
  return ((ScalaJS.is.Lcom_chandu0101_services_StoreServiceFactory$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.chandu0101.services.StoreServiceFactory$"))
});
ScalaJS.isArrayOf.Lcom_chandu0101_services_StoreServiceFactory$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_chandu0101_services_StoreServiceFactory$)))
});
ScalaJS.asArrayOf.Lcom_chandu0101_services_StoreServiceFactory$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_chandu0101_services_StoreServiceFactory$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.chandu0101.services.StoreServiceFactory$;", depth))
});
ScalaJS.d.Lcom_chandu0101_services_StoreServiceFactory$ = new ScalaJS.ClassTypeData({
  Lcom_chandu0101_services_StoreServiceFactory$: 0
}, false, "com.chandu0101.services.StoreServiceFactory$", ScalaJS.d.O, {
  Lcom_chandu0101_services_StoreServiceFactory$: 1,
  Lcom_greencatsoft_angularjs_Factory: 1,
  F0: 1,
  Lcom_greencatsoft_angularjs_NamedService: 1,
  Lcom_greencatsoft_angularjs_Named: 1,
  Lcom_greencatsoft_angularjs_Service: 1,
...
ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$.prototype.$classData = ScalaJS.d.Lcom_chandu0101_services_StoreServiceFactory$;
ScalaJS.n.Lcom_chandu0101_services_StoreServiceFactory = (void 0);
ScalaJS.m.Lcom_chandu0101_services_StoreServiceFactory = (function() {
  if ((!ScalaJS.n.Lcom_chandu0101_services_StoreServiceFactory)) {
    ScalaJS.n.Lcom_chandu0101_services_StoreServiceFactory = new ScalaJS.c.Lcom_chandu0101_services_StoreServiceFactory$().init___()
  };
  return ScalaJS.n.Lcom_chandu0101_services_StoreServiceFactory
});
/** @constructor */
ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$.prototype.constructor = ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$;
/** @constructor */
ScalaJS.h.Lcom_greencatsoft_angularjs_Angular$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_greencatsoft_angularjs_Angular$.prototype = ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$.prototype;
ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$.prototype.module__T__sc_Seq__Lcom_greencatsoft_angularjs_Module = (function(name, dependencies) {
  var jsx$2 = ScalaJS.g["angular"];
  var $$this = (ScalaJS.m.s_Predef().singleton$und$less$colon$less$2, ScalaJS.as.sc_GenTraversableOnce(dependencies));
  var this$3 = ScalaJS.m.sjsr_package();
  var result = new ScalaJS.g["Array"]();
  $$this.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2$1, result$1) {
    return (function(x$2) {
  ...
  var jsx$1 = jsx$2["module"](name, result);
  return new ScalaJS.c.Lcom_greencatsoft_angularjs_Module().init___Lcom_greencatsoft_angularjs_internal_Module(jsx$1)
});
ScalaJS.is.Lcom_greencatsoft_angularjs_Angular$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Angular$)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Angular$ = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Angular$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Angular$"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Angular$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Angular$)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Angular$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Angular$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Angular$;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Angular$ = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Angular$: 0
}, false, "com.greencatsoft.angularjs.Angular$", ScalaJS.d.O, {
  Lcom_greencatsoft_angularjs_Angular$: 1,
  O: 1
});
ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$.prototype.$classData = ScalaJS.d.Lcom_greencatsoft_angularjs_Angular$;
ScalaJS.n.Lcom_greencatsoft_angularjs_Angular = (void 0);
ScalaJS.m.Lcom_greencatsoft_angularjs_Angular = (function() {
  if ((!ScalaJS.n.Lcom_greencatsoft_angularjs_Angular)) {
    ScalaJS.n.Lcom_greencatsoft_angularjs_Angular = new ScalaJS.c.Lcom_greencatsoft_angularjs_Angular$().init___()
  };
  return ScalaJS.n.Lcom_greencatsoft_angularjs_Angular
});
ScalaJS.is.Lcom_greencatsoft_angularjs_Controller = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Controller)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Controller = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Controller(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Controller"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Controller = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Controller)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Controller = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Controller(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Controller;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Controller = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Controller: 0
}, true, "com.greencatsoft.angularjs.Controller", (void 0), {
  Lcom_greencatsoft_angularjs_Controller: 1,
  Lcom_greencatsoft_angularjs_core_ScopeAware: 1,
  Lcom_greencatsoft_angularjs_core_Scoped: 1,
  Lcom_greencatsoft_angularjs_Initializable: 1,
...
ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Initializable)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Initializable"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Initializable = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Initializable)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Initializable = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Initializable(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Initializable;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Initializable = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Initializable: 0
}, true, "com.greencatsoft.angularjs.Initializable", (void 0), {
  Lcom_greencatsoft_angularjs_Initializable: 1,
  O: 1
});
ScalaJS.is.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.IsolatedScope$ScopeBinding"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.IsolatedScope$ScopeBinding;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding: 0
}, false, "com.greencatsoft.angularjs.IsolatedScope$ScopeBinding", ScalaJS.d.O, {
  Lcom_greencatsoft_angularjs_IsolatedScope$ScopeBinding: 1,
  O: 1
});
/** @constructor */
ScalaJS.c.Lcom_greencatsoft_angularjs_Module = (function() {
  ScalaJS.c.O.call(this);
  this.module$1 = null
});
ScalaJS.c.Lcom_greencatsoft_angularjs_Module.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_greencatsoft_angularjs_Module.prototype.constructor = ScalaJS.c.Lcom_greencatsoft_angularjs_Module;
/** @constructor */
ScalaJS.h.Lcom_greencatsoft_angularjs_Module = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_greencatsoft_angularjs_Module.prototype = ScalaJS.c.Lcom_greencatsoft_angularjs_Module.prototype;
ScalaJS.c.Lcom_greencatsoft_angularjs_Module.prototype.init___Lcom_greencatsoft_angularjs_internal_Module = (function(module) {
  this.module$1 = module;
  var requirement = (module !== null);
  if ((!requirement)) {
    throw new ScalaJS.c.jl_IllegalArgumentException().init___T(("requirement failed: " + "Missing argument 'module'."))
  };
  return this
});
ScalaJS.is.Lcom_greencatsoft_angularjs_Module = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Module)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Module = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Module(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Module"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Module = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Module)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Module = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Module(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Module;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Module = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Module: 0
}, false, "com.greencatsoft.angularjs.Module", ScalaJS.d.O, {
  Lcom_greencatsoft_angularjs_Module: 1,
  O: 1
});
ScalaJS.c.Lcom_greencatsoft_angularjs_Module.prototype.$classData = ScalaJS.d.Lcom_greencatsoft_angularjs_Module;
ScalaJS.is.Lcom_greencatsoft_angularjs_Service = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Service)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Service = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Service(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Service"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Service = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Service)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Service = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Service(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Service;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Service = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Service: 0
}, true, "com.greencatsoft.angularjs.Service", (void 0), {
  Lcom_greencatsoft_angularjs_Service: 1,
  O: 1
});
/** @constructor */
ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function() {
  ScalaJS.c.O.call(this);
  this.scope$1 = null;
  this.$$outer$f = null
});
ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype.constructor = ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope;
/** @constructor */
ScalaJS.h.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype = ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype;
ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype.init___Lcom_greencatsoft_angularjs_core_Scoped__Lcom_greencatsoft_angularjs_core_Scope = (function($$outer, scope) {
  this.scope$1 = scope;
  if (($$outer === null)) {
...
ScalaJS.is.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.core.Scoped$DynamicScope"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.core.Scoped$DynamicScope;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope: 0
}, false, "com.greencatsoft.angularjs.core.Scoped$DynamicScope", ScalaJS.d.O, {
  Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope: 1,
  O: 1
});
ScalaJS.c.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope.prototype.$classData = ScalaJS.d.Lcom_greencatsoft_angularjs_core_Scoped$DynamicScope;
/** @constructor */
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype = new ScalaJS.h.O();
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype.constructor = ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$;
/** @constructor */
ScalaJS.h.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype = ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype;
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype.bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V = (function(service, target) {
  try {
    service["_ng_service_proxy"] = target
  } catch (ex) {
...
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype.unbind__sjs_js_Any__s_Option = (function(service) {
  var target = ScalaJS.m.sjs_js_UndefOr().any2undefOrA__O__sjs_js_UndefOr(service["_ng_service_proxy"]);
  var $$this = ((target === (void 0)) ? (void 0) : ScalaJS.m.sjs_js_UndefOr().any2undefOrA__O__sjs_js_UndefOr(ScalaJS.as.Lcom_greencatsoft_angularjs_Service(target)));
  return (($$this === (void 0)) ? ScalaJS.m.s_None() : new ScalaJS.c.s_Some().init___O($$this))
});
ScalaJS.is.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_internal_ServiceProxy$)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_internal_ServiceProxy$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.internal.ServiceProxy$"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_internal_ServiceProxy$)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_internal_ServiceProxy$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.internal.ServiceProxy$;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_internal_ServiceProxy$ = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_internal_ServiceProxy$: 0
}, false, "com.greencatsoft.angularjs.internal.ServiceProxy$", ScalaJS.d.O, {
  Lcom_greencatsoft_angularjs_internal_ServiceProxy$: 1,
  O: 1
});
ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$.prototype.$classData = ScalaJS.d.Lcom_greencatsoft_angularjs_internal_ServiceProxy$;
ScalaJS.n.Lcom_greencatsoft_angularjs_internal_ServiceProxy = (void 0);
ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy = (function() {
  if ((!ScalaJS.n.Lcom_greencatsoft_angularjs_internal_ServiceProxy)) {
    ScalaJS.n.Lcom_greencatsoft_angularjs_internal_ServiceProxy = new ScalaJS.c.Lcom_greencatsoft_angularjs_internal_ServiceProxy$().init___()
  };
  return ScalaJS.n.Lcom_greencatsoft_angularjs_internal_ServiceProxy
});
/** @constructor */
...
ScalaJS.c.sc_AbstractTraversable.prototype.flatten__F1__sc_GenTraversable = (function(asTraversable) {
  return ScalaJS.i.scg_GenericTraversableTemplate$class__flatten__scg_GenericTraversableTemplate__F1__sc_GenTraversable(this, asTraversable)
});
...
ScalaJS.is.scg_GenericTraversableTemplate = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scg_GenericTraversableTemplate)))
});
ScalaJS.as.scg_GenericTraversableTemplate = (function(obj) {
  return ((ScalaJS.is.scg_GenericTraversableTemplate(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.collection.generic.GenericTraversableTemplate"))
});
ScalaJS.isArrayOf.scg_GenericTraversableTemplate = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scg_GenericTraversableTemplate)))
});
ScalaJS.asArrayOf.scg_GenericTraversableTemplate = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.scg_GenericTraversableTemplate(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.collection.generic.GenericTraversableTemplate;", depth))
});
ScalaJS.d.scg_GenericTraversableTemplate = new ScalaJS.ClassTypeData({
  scg_GenericTraversableTemplate: 0
}, true, "scala.collection.generic.GenericTraversableTemplate", (void 0), {
  scg_GenericTraversableTemplate: 1,
  scg_HasNewBuilder: 1,
  O: 1
});
...
ScalaJS.c.sci_Stream$ConsWrapper.prototype.$$hash$colon$colon$colon__sci_Stream__sci_Stream = (function(prefix) {
...
ScalaJS.c.sjs_js_UndefOr$.prototype.any2undefOrA__O__sjs_js_UndefOr = (function(value) {
  return value
});
...
ScalaJS.as.sjs_js_UndefOr$ = (function(obj) {
  return ((ScalaJS.is.sjs_js_UndefOr$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.scalajs.js.UndefOr$"))
});
...
ScalaJS.asArrayOf.sjs_js_UndefOr$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sjs_js_UndefOr$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.scalajs.js.UndefOr$;", depth))
});
...
ScalaJS.n.sjs_js_UndefOr = (void 0);
...
/** @constructor */
ScalaJS.c.sr_AbstractFunction11 = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sr_AbstractFunction11.prototype = new ScalaJS.h.O();
ScalaJS.c.sr_AbstractFunction11.prototype.constructor = ScalaJS.c.sr_AbstractFunction11;
/** @constructor */
ScalaJS.h.sr_AbstractFunction11 = (function() {
  /*<skip>*/
});
ScalaJS.h.sr_AbstractFunction11.prototype = ScalaJS.c.sr_AbstractFunction11.prototype;
ScalaJS.c.sr_AbstractFunction11.prototype.toString__T = (function() {
  return "<function11>"
});
ScalaJS.is.sr_AbstractFunction11 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sr_AbstractFunction11)))
});
ScalaJS.as.sr_AbstractFunction11 = (function(obj) {
  return ((ScalaJS.is.sr_AbstractFunction11(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.runtime.AbstractFunction11"))
});
ScalaJS.isArrayOf.sr_AbstractFunction11 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sr_AbstractFunction11)))
});
ScalaJS.asArrayOf.sr_AbstractFunction11 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sr_AbstractFunction11(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.runtime.AbstractFunction11;", depth))
});
ScalaJS.d.sr_AbstractFunction11 = new ScalaJS.ClassTypeData({
  sr_AbstractFunction11: 0
}, false, "scala.runtime.AbstractFunction11", ScalaJS.d.O, {
  sr_AbstractFunction11: 1,
  F11: 1,
  O: 1
});
ScalaJS.c.sr_AbstractFunction11.prototype.$classData = ScalaJS.d.sr_AbstractFunction11;
/** @constructor */
...
/** @constructor */
ScalaJS.c.sr_AbstractFunction4 = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.sr_AbstractFunction4.prototype = new ScalaJS.h.O();
ScalaJS.c.sr_AbstractFunction4.prototype.constructor = ScalaJS.c.sr_AbstractFunction4;
/** @constructor */
ScalaJS.h.sr_AbstractFunction4 = (function() {
  /*<skip>*/
});
ScalaJS.h.sr_AbstractFunction4.prototype = ScalaJS.c.sr_AbstractFunction4.prototype;
ScalaJS.c.sr_AbstractFunction4.prototype.toString__T = (function() {
  return "<function4>"
});
ScalaJS.is.sr_AbstractFunction4 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.sr_AbstractFunction4)))
});
ScalaJS.as.sr_AbstractFunction4 = (function(obj) {
  return ((ScalaJS.is.sr_AbstractFunction4(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "scala.runtime.AbstractFunction4"))
});
ScalaJS.isArrayOf.sr_AbstractFunction4 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.sr_AbstractFunction4)))
});
ScalaJS.asArrayOf.sr_AbstractFunction4 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.sr_AbstractFunction4(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lscala.runtime.AbstractFunction4;", depth))
});
ScalaJS.d.sr_AbstractFunction4 = new ScalaJS.ClassTypeData({
  sr_AbstractFunction4: 0
}, false, "scala.runtime.AbstractFunction4", ScalaJS.d.O, {
  sr_AbstractFunction4: 1,
  F4: 1,
  O: 1
});
ScalaJS.c.sr_AbstractFunction4.prototype.$classData = ScalaJS.d.sr_AbstractFunction4;
/** @constructor */
...
/** @constructor */
ScalaJS.c.LApp$$anonfun$1 = (function() {
  ScalaJS.c.sr_AbstractFunction11.call(this);
  this.target$1$2 = null
});
ScalaJS.c.LApp$$anonfun$1.prototype = new ScalaJS.h.sr_AbstractFunction11();
ScalaJS.c.LApp$$anonfun$1.prototype.constructor = ScalaJS.c.LApp$$anonfun$1;
/** @constructor */
ScalaJS.h.LApp$$anonfun$1 = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$$anonfun$1.prototype = ScalaJS.c.LApp$$anonfun$1.prototype;
ScalaJS.c.LApp$$anonfun$1.prototype.init___Lcom_greencatsoft_angularjs_Service = (function(target$1) {
  this.target$1$2 = target$1;
  return this
});
ScalaJS.c.LApp$$anonfun$1.prototype.apply__O__O__O__O__O__O__O__O__O__O__O__O = (function(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) {
  var t = v1;
  ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V(t, this.target$1$2);
  var x1 = this.target$1$2;
  if (ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(x1)) {
    var this$1 = ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable(x1);
    ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V(this$1)
  };
  var x1$2 = this.target$1$2;
  var result = (ScalaJS.is.F0(x1$2) ? ScalaJS.as.F0(x1$2).apply__O() : null);
  var this$2 = ScalaJS.m.s_Option().apply__O__s_Option(result);
  if (this$2.isEmpty__Z()) {
    var $$this = ScalaJS.m.s_None()
  } else {
    var x$1$2 = this$2.get__O();
    var $$this = new ScalaJS.c.s_Some().init___O(x$1$2)
  };
  if ($$this.isEmpty__Z()) {
    var value = (void 0);
    return value
    ...
    var v$2 = $$this.get__O();
    return ScalaJS.m.sjs_js_UndefOr().any2undefOrA__O__sjs_js_UndefOr(v$2)
  }
});
ScalaJS.is.LApp$$anonfun$1 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$$anonfun$1)))
});
ScalaJS.as.LApp$$anonfun$1 = (function(obj) {
  return ((ScalaJS.is.LApp$$anonfun$1(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$$anonfun$1"))
});
ScalaJS.isArrayOf.LApp$$anonfun$1 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$$anonfun$1)))
});
ScalaJS.asArrayOf.LApp$$anonfun$1 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$$anonfun$1(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$$anonfun$1;", depth))
});
ScalaJS.d.LApp$$anonfun$1 = new ScalaJS.ClassTypeData({
  LApp$$anonfun$1: 0
}, false, "App$$anonfun$1", ScalaJS.d.sr_AbstractFunction11, {
  LApp$$anonfun$1: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction11: 1,
...
ScalaJS.c.LApp$$anonfun$1.prototype.$classData = ScalaJS.d.LApp$$anonfun$1;
/** @constructor */
ScalaJS.c.LApp$$anonfun$2 = (function() {
  ScalaJS.c.sr_AbstractFunction11.call(this);
  this.target$2$2 = null
});
ScalaJS.c.LApp$$anonfun$2.prototype = new ScalaJS.h.sr_AbstractFunction11();
ScalaJS.c.LApp$$anonfun$2.prototype.constructor = ScalaJS.c.LApp$$anonfun$2;
/** @constructor */
ScalaJS.h.LApp$$anonfun$2 = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$$anonfun$2.prototype = ScalaJS.c.LApp$$anonfun$2.prototype;
ScalaJS.c.LApp$$anonfun$2.prototype.init___Lcom_greencatsoft_angularjs_Service = (function(target$2) {
  this.target$2$2 = target$2;
  return this
});
ScalaJS.c.LApp$$anonfun$2.prototype.apply__O__O__O__O__O__O__O__O__O__O__O__O = (function(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) {
  var t = v1;
  var a0 = v2;
  var a1 = v3;
  ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V(t, this.target$2$2);
  ScalaJS.m.Lcom_chandu0101_controllers_StoreController().service$1 = ScalaJS.as.Lcom_chandu0101_services_StoreService(a0);
  ScalaJS.m.Lcom_chandu0101_controllers_StoreController().rawScope$1 = a1;
  var x1 = this.target$2$2;
  if (ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(x1)) {
    var this$1 = ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable(x1);
    ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V(this$1)
  };
  var x1$2 = this.target$2$2;
  var result = (ScalaJS.is.F0(x1$2) ? ScalaJS.as.F0(x1$2).apply__O() : null);
  var this$2 = ScalaJS.m.s_Option().apply__O__s_Option(result);
  if (this$2.isEmpty__Z()) {
    var $$this = ScalaJS.m.s_None()
    ...
    var $$this = new ScalaJS.c.s_Some().init___O(x$2$2)
  };
  if ($$this.isEmpty__Z()) {
    var value = (void 0);
    return value
...
ScalaJS.is.LApp$$anonfun$2 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$$anonfun$2)))
});
ScalaJS.as.LApp$$anonfun$2 = (function(obj) {
  return ((ScalaJS.is.LApp$$anonfun$2(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$$anonfun$2"))
});
ScalaJS.isArrayOf.LApp$$anonfun$2 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$$anonfun$2)))
});
ScalaJS.asArrayOf.LApp$$anonfun$2 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$$anonfun$2(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$$anonfun$2;", depth))
});
ScalaJS.d.LApp$$anonfun$2 = new ScalaJS.ClassTypeData({
  LApp$$anonfun$2: 0
}, false, "App$$anonfun$2", ScalaJS.d.sr_AbstractFunction11, {
  LApp$$anonfun$2: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction11: 1,
...
ScalaJS.c.LApp$$anonfun$2.prototype.$classData = ScalaJS.d.LApp$$anonfun$2;
/** @constructor */
ScalaJS.c.LApp$$anonfun$3 = (function() {
  ScalaJS.c.sr_AbstractFunction11.call(this);
  this.target$3$2 = null
});
ScalaJS.c.LApp$$anonfun$3.prototype = new ScalaJS.h.sr_AbstractFunction11();
ScalaJS.c.LApp$$anonfun$3.prototype.constructor = ScalaJS.c.LApp$$anonfun$3;
/** @constructor */
ScalaJS.h.LApp$$anonfun$3 = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$$anonfun$3.prototype = ScalaJS.c.LApp$$anonfun$3.prototype;
ScalaJS.c.LApp$$anonfun$3.prototype.init___Lcom_greencatsoft_angularjs_Service = (function(target$3) {
  this.target$3$2 = target$3;
  return this
});
ScalaJS.c.LApp$$anonfun$3.prototype.apply__O__O__O__O__O__O__O__O__O__O__O__O = (function(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) {
  var t = v1;
  var a0 = v2;
  ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V(t, this.target$3$2);
  ScalaJS.m.Lcom_chandu0101_controllers_PanelController().rawScope$1 = a0;
  var x1 = this.target$3$2;
  if (ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(x1)) {
    var this$1 = ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable(x1);
    ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V(this$1)
  };
  var x1$2 = this.target$3$2;
  var result = (ScalaJS.is.F0(x1$2) ? ScalaJS.as.F0(x1$2).apply__O() : null);
  var this$2 = ScalaJS.m.s_Option().apply__O__s_Option(result);
  if (this$2.isEmpty__Z()) {
    var $$this = ScalaJS.m.s_None()
  } else {
    var x$3$2 = this$2.get__O();
    var $$this = new ScalaJS.c.s_Some().init___O(x$3$2)
  };
  if ($$this.isEmpty__Z()) {
    var value = (void 0);
    return value
...
ScalaJS.is.LApp$$anonfun$3 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$$anonfun$3)))
});
ScalaJS.as.LApp$$anonfun$3 = (function(obj) {
  return ((ScalaJS.is.LApp$$anonfun$3(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$$anonfun$3"))
});
ScalaJS.isArrayOf.LApp$$anonfun$3 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$$anonfun$3)))
});
ScalaJS.asArrayOf.LApp$$anonfun$3 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$$anonfun$3(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$$anonfun$3;", depth))
});
ScalaJS.d.LApp$$anonfun$3 = new ScalaJS.ClassTypeData({
  LApp$$anonfun$3: 0
}, false, "App$$anonfun$3", ScalaJS.d.sr_AbstractFunction11, {
  LApp$$anonfun$3: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction11: 1,
...
ScalaJS.c.LApp$$anonfun$3.prototype.$classData = ScalaJS.d.LApp$$anonfun$3;
/** @constructor */
ScalaJS.c.LApp$$anonfun$4 = (function() {
  ScalaJS.c.sr_AbstractFunction11.call(this);
  this.target$4$2 = null
});
ScalaJS.c.LApp$$anonfun$4.prototype = new ScalaJS.h.sr_AbstractFunction11();
ScalaJS.c.LApp$$anonfun$4.prototype.constructor = ScalaJS.c.LApp$$anonfun$4;
/** @constructor */
ScalaJS.h.LApp$$anonfun$4 = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$$anonfun$4.prototype = ScalaJS.c.LApp$$anonfun$4.prototype;
ScalaJS.c.LApp$$anonfun$4.prototype.init___Lcom_greencatsoft_angularjs_Service = (function(target$4) {
  this.target$4$2 = target$4;
  return this
});
ScalaJS.c.LApp$$anonfun$4.prototype.apply__O__O__O__O__O__O__O__O__O__O__O__O = (function(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) {
  var t = v1;
  var a0 = v2;
  ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V(t, this.target$4$2);
  ScalaJS.m.Lcom_chandu0101_controllers_ReviewController().rawScope$1 = a0;
  var x1 = this.target$4$2;
  if (ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(x1)) {
    var this$1 = ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable(x1);
    ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V(this$1)
  };
  var x1$2 = this.target$4$2;
  var result = (ScalaJS.is.F0(x1$2) ? ScalaJS.as.F0(x1$2).apply__O() : null);
  var this$2 = ScalaJS.m.s_Option().apply__O__s_Option(result);
  if (this$2.isEmpty__Z()) {
    var $$this = ScalaJS.m.s_None()
  } else {
    var x$4$2 = this$2.get__O();
    var $$this = new ScalaJS.c.s_Some().init___O(x$4$2)
  };
  if ($$this.isEmpty__Z()) {
    var value = (void 0);
    return value
...
ScalaJS.is.LApp$$anonfun$4 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$$anonfun$4)))
});
ScalaJS.as.LApp$$anonfun$4 = (function(obj) {
  return ((ScalaJS.is.LApp$$anonfun$4(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$$anonfun$4"))
});
ScalaJS.isArrayOf.LApp$$anonfun$4 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$$anonfun$4)))
});
ScalaJS.asArrayOf.LApp$$anonfun$4 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$$anonfun$4(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$$anonfun$4;", depth))
});
ScalaJS.d.LApp$$anonfun$4 = new ScalaJS.ClassTypeData({
  LApp$$anonfun$4: 0
}, false, "App$$anonfun$4", ScalaJS.d.sr_AbstractFunction11, {
  LApp$$anonfun$4: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction11: 1,
...
ScalaJS.c.LApp$$anonfun$4.prototype.$classData = ScalaJS.d.LApp$$anonfun$4;
/** @constructor */
ScalaJS.c.LApp$$anonfun$5 = (function() {
  ScalaJS.c.sr_AbstractFunction11.call(this);
  this.target$5$2 = null
});
ScalaJS.c.LApp$$anonfun$5.prototype = new ScalaJS.h.sr_AbstractFunction11();
ScalaJS.c.LApp$$anonfun$5.prototype.constructor = ScalaJS.c.LApp$$anonfun$5;
/** @constructor */
ScalaJS.h.LApp$$anonfun$5 = (function() {
  /*<skip>*/
});
ScalaJS.h.LApp$$anonfun$5.prototype = ScalaJS.c.LApp$$anonfun$5.prototype;
ScalaJS.c.LApp$$anonfun$5.prototype.init___Lcom_greencatsoft_angularjs_Service = (function(target$5) {
  this.target$5$2 = target$5;
  return this
});
ScalaJS.c.LApp$$anonfun$5.prototype.apply__O__O__O__O__O__O__O__O__O__O__O__O = (function(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) {
  var t = v1;
  var a0 = v2;
  ScalaJS.m.Lcom_greencatsoft_angularjs_internal_ServiceProxy().bind__sjs_js_Any__Lcom_greencatsoft_angularjs_Service__V(t, this.target$5$2);
  ScalaJS.m.Lcom_chandu0101_services_StoreServiceFactory().http$1 = a0;
  var x1 = this.target$5$2;
  if (ScalaJS.is.Lcom_greencatsoft_angularjs_Initializable(x1)) {
    var this$1 = ScalaJS.as.Lcom_greencatsoft_angularjs_Initializable(x1);
    ScalaJS.i.Lcom_greencatsoft_angularjs_Controller$class__initialize__Lcom_greencatsoft_angularjs_Controller__V(this$1)
  };
  var x1$2 = this.target$5$2;
  var result = (ScalaJS.is.F0(x1$2) ? ScalaJS.as.F0(x1$2).apply__O() : null);
  var this$2 = ScalaJS.m.s_Option().apply__O__s_Option(result);
  if (this$2.isEmpty__Z()) {
    var $$this = ScalaJS.m.s_None()
  } else {
    var x$5$2 = this$2.get__O();
    var $$this = new ScalaJS.c.s_Some().init___O(x$5$2)
  };
  if ($$this.isEmpty__Z()) {
    var value = (void 0);
    return value
...
ScalaJS.is.LApp$$anonfun$5 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LApp$$anonfun$5)))
});
ScalaJS.as.LApp$$anonfun$5 = (function(obj) {
  return ((ScalaJS.is.LApp$$anonfun$5(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "App$$anonfun$5"))
});
ScalaJS.isArrayOf.LApp$$anonfun$5 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LApp$$anonfun$5)))
});
ScalaJS.asArrayOf.LApp$$anonfun$5 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LApp$$anonfun$5(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LApp$$anonfun$5;", depth))
});
ScalaJS.d.LApp$$anonfun$5 = new ScalaJS.ClassTypeData({
  LApp$$anonfun$5: 0
}, false, "App$$anonfun$5", ScalaJS.d.sr_AbstractFunction11, {
  LApp$$anonfun$5: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction11: 1,
...
ScalaJS.c.LApp$$anonfun$5.prototype.$classData = ScalaJS.d.LApp$$anonfun$5;
/** @constructor */
ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function() {
  ScalaJS.c.sr_AbstractFunction4.call(this);
  this.$$outer$2 = null
});
ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype = new ScalaJS.h.sr_AbstractFunction4();
ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype.constructor = ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1;
/** @constructor */
ScalaJS.h.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function() {
  /*<skip>*/
});
ScalaJS.h.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype = ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype;
ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype.init___Lcom_greencatsoft_angularjs_Directive = (function($$outer) {
  if (($$outer === null)) {
    throw ScalaJS.unwrapJavaScriptException(null)
  } else {
    this.$$outer$2 = $$outer
...
ScalaJS.is.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1)))
});
ScalaJS.as.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function(obj) {
  return ((ScalaJS.is.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "com.greencatsoft.angularjs.Directive$$anonfun$buildConfig$1"))
});
ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1)))
});
ScalaJS.asArrayOf.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Lcom.greencatsoft.angularjs.Directive$$anonfun$buildConfig$1;", depth))
});
ScalaJS.d.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1 = new ScalaJS.ClassTypeData({
  Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1: 0
}, false, "com.greencatsoft.angularjs.Directive$$anonfun$buildConfig$1", ScalaJS.d.sr_AbstractFunction4, {
  Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction4: 1,
  F4: 1,
...
ScalaJS.c.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1.prototype.$classData = ScalaJS.d.Lcom_greencatsoft_angularjs_Directive$$anonfun$buildConfig$1;
/** @constructor */
...
ScalaJS.c.s_Array$.prototype.apply__sc_Seq__s_reflect_ClassTag__O = (function(xs, evidence$2) {
  ...
  var f = new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, array$1, i$1) {
    return (function(x$2) {
      ScalaJS.m.sr_ScalaRunTime().array$undupdate__O__I__O__V(array$1, i$1.elem$1, x$2);
...
ScalaJS.c.sci_Stream.prototype.flatten__F1__sc_GenTraversable = (function(asTraversable) {
...
ScalaJS.c.sci_Stream.prototype.flatten__F1__sci_Stream = (function(asTraversable) {
  var st = new ScalaJS.c.sr_ObjectRef().init___O(this);
  while (true) {
    var this$2 = ScalaJS.as.sci_Stream(st.elem$1);
    if (ScalaJS.i.sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$2)) {
      var h = ScalaJS.as.sc_GenTraversableOnce(asTraversable.apply__O__O(ScalaJS.as.sci_Stream(st.elem$1).head__O()));
      if (h.isEmpty__Z()) {
        st.elem$1 = ScalaJS.as.sci_Stream(ScalaJS.as.sci_Stream(st.elem$1).tail__O())
      } else {
        var x$4 = h.toStream__sci_Stream();
        ScalaJS.m.sci_Stream();
        var stream = new ScalaJS.c.sjsr_AnonFunction0().init___sjs_js_Function0((function(this$2$1, asTraversable$1, st$1) {
          return (function() {
            return ScalaJS.as.sci_Stream(ScalaJS.as.sci_Stream(st$1.elem$1).tail__O()).flatten__F1__sci_Stream(asTraversable$1)
          })
        })(this, asTraversable, st));
        return new ScalaJS.c.sci_Stream$ConsWrapper().init___F0(stream).$$hash$colon$colon$colon__sci_Stream__sci_Stream(x$4)
      }
    } else {
      break
    }
...
//# sourceMappingURL=angularscala-fastopt.js.map
